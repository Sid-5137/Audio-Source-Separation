...
class MUSDB18HQDataset(Dataset):
    ...
    def __getitem__(self, idx):
        track_name = self.tracks[idx]  # Get the track name
        track_dir = os.path.join(self.root_dir, track_name)
        ...
        # Return all required elements including the track name
        return mixture_mag, targets_mag, mixture_spec, vocals_spec, drums_spec, bass_spec, other_spec, track_name
